function init() {
    ...
    document.getElementById('kategorije').addEventListener('click', e => {
    ...
    document.getElementById('produkti').addEventListener('click', e => {
        document.cookie = `token=${document.cookie.split("=")[1]};SameSite=Lax`;
        window.location.href = 'produkti.html';
    });

    document.getElementById('rezervacija').addEventListener('click', e => {
        document.cookie = `token=${document.cookie.split("=")[1]};SameSite=Lax`;
